//COPYRIGHT ARCANE ROBOTICS 2023 DELTA ROBOT DOG
//YOU CAN EDIT AND USE THIS CODE AS YOU WANT INCLUDING REDISTRIBUTING IT, HOWEVER YOU MAY NOT SELL IT EVEN IF EDITED.
#include <EEPROM.h>
#include <Wire.h>
